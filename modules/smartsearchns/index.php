	...
	<form name="frmSearch" action="?m=<?php echo $m ;?>"  method="POST">
			<table cellspacing="5" cellpadding="0" border="0">
				<tr>
					...
					<td align="left"><INPUT class="text" size="18" type="text" id="keyword" name="keyword" value="<?php echo dPformSafe(@$_POST['keyword']); ?>"></td>
			...
			<div id="div_advancedsearch" name="div_advancedsearch"  style="<?php  echo ($ssearch['advanced_search']=="on" ? 'display:block':'display:none'); ?> ">
				<table cellspacing="5" cellpadding="0" border="0">
					<tr>
						<td align="left"> 2. </td>
						<td align="left"><INPUT class="text" size="18" type="text" id="keyword2" name="keyword2" value="<?php echo dPformSafe(@$_POST['keyword2']); ?>"></td>
						<td align="left"> 3. <INPUT class="text" size="18" type="text" id="keyword3" name="keyword3" value="<?php echo dPformSafe(@$_POST['keyword3']); ?>"></td>
						<td align="left"> 4. <INPUT class="text" size="18" type="text" id="keyword4" name="keyword4" value="<?php echo dPformSafe(@$_POST['keyword4']); ?>"></td>
