...
foreach ($list1 as $line) {
    ...
    $q2 = new DBQuery();
    $q2->addTable('risks');
    $q2->addUpdate('risk_priority', $Priority);
    $q2->addWhere("risk_id = '$risk_id'");
    if (!$q2->exec()) {
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="tbl">
    <tr>
        ...
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_id"
                class="hdr"><?php echo $AppUI->_('LBL_ID'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                ...
                class="hdr"><?php echo $AppUI->_('LBL_NAME'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_description"
                class="hdr"><?php echo $AppUI->_('LBL_DESCRIPTION'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_probability"
                class="hdr"><?php echo $AppUI->_('LBL_PROBABILITY'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_impact"
                class="hdr"><?php echo $AppUI->_('LBL_IMPACT'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                ...
                class="hdr"><?php echo $AppUI->_('LBL_PRIORITY'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_status"
                class="hdr"><?php echo $AppUI->_('LBL_STATUS'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_responsible"
                class="hdr"><?php echo $AppUI->_('LBL_OWNER'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_project"
                class="hdr"><?php echo $AppUI->_('LBL_PROJECT'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                ...
                class="hdr"><?php echo $AppUI->_('LBL_TASK'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_potential_other_projects"
                class="hdr"><?php echo $AppUI->_('LBL_POTENTIAL'); ?></a></th>
        <th nowrap="nowrap"><a
                href="<?php if ($projectSelected != null) {
                    echo '?m=projects&a=view&project_id=' . $projectSelected . 'tab=' . $t;
                } else {
                    echo '?m=risks';
                } ?>&orderbyy=risk_strategy"
                class="hdr"><?php echo $AppUI->_('LBL_STRATEGY'); ?></a></th>
    </tr>
    <?php foreach ($activeList as $row) {
        ...
        <tr>
            <td nowrap style="background-color:#<?php echo $bg; ?>">
                <a
                    href="index.php?m=risks&a=addedit&id=<?php echo ($row['risk_id']);
                    if ($projectSelected != null) {
                ...
                <a
                    href="index.php?m=risks&a=view&id=<?php echo ($row['risk_id']);
                    if ($projectSelected != null) {
                        echo ('&project_id=' . $projectSelected . '&tab=' . $t);
                    } ?>">
            ...
            <td
                style="background-color:#<?php if ($row['risk_priority'] == 0) {
                    echo $bgGreen;
                } else {
