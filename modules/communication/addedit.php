            ...
            <td width="100%" valign="top" align="left">
                <table cellspacing="1" cellpadding="2" width="60%" charset=UTF-8>
                    ...
                    <tr><td align="left" nowrap="nowrap"><?php echo $AppUI->_("LBL_TITLE"); ?>:</td>
                        <td><input type="text" align="left" name="communication_title" cols="50" rows="1" value="<?php echo (isset($_GET['title']) ? htmlspecialchars($_GET['title'], ENT_QUOTES) : @$obj->communication_title); ?>"></input></td>
                    </tr>
                    <tr><td align="left" nowrap="nowrap"><?php echo $AppUI->_("LBL_COMMUNICATION"); ?>:</td>
                        <td align="left"><textarea name="communication_information" cols="100" rows="3" class="textarea"><?php echo (isset($_GET['communication']) ? htmlspecialchars($_GET['communication'], ENT_QUOTES) : @$obj->communication_information); ?></textarea></td>
                    </tr>  
                    <?php
                  ...
                  ?></select>
                    ...
                    <input type="text" style="<?php echo ($showdate ? '' : 'display:none;'); ?> margin-left: 10px;" value="<?php echo ($communication_id == 0 ? htmlspecialchars($_GET['communication_date'], ENT_QUOTES) : @$obj->communication_date);  ?>" name="communication_date">
                    </td>
                 </tr>
                 <tr><td align="left" nowrap="nowrap"><?php echo $AppUI->_("LBL_RESTRICTIONS");?>: </td>
                     <td align="left"><textarea name="communication_restrictions" cols="100" rows="3" class="textarea"><?php echo ($communication_id == 0 ? htmlspecialchars(dPgetParam($_GET, 'restrictions', ''), ENT_QUOTES) : @$obj->communication_restrictions); ?></textarea></td>
                 </tr>
