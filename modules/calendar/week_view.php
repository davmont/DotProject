...
$first_time = new CDate(Date_calc::beginOfWeek(
	$dd,
	$mm,
	$yy,
	FMT_TIMESTAMP_DATE,
...
$prev_week = new CDate(Date_calc::beginOfPrevWeek(
	$dd,
	$mm,
	$yy,
	FMT_TIMESTAMP_DATE,
...
$next_week = new CDate(Date_calc::beginOfNextWeek(
	$dd,
	$mm,
	$yy,
	FMT_TIMESTAMP_DATE,
...
$companies = $company->getAllowedRecords(
	$AppUI->user_id,
...
<table class="weekTable" style="margin-top: 5px;">
	<?php
	$column = 0;
	$show_day = $this_week;
