...
<table cellspacing="0" cellpadding="4" border="0" width="100%" class="std">
	<form onclick="check_backup_options()" name="frmBackup"
		action="<?php echo "$baseUrl/index.php?m=backup&a=do_backup&suppressHeaders=1"; ?>" method="post">
		<tr>
		...
		<tr>
			...
			<td width="100%" nowrap="nowrap">
				<input type="checkbox" name="droptable" value="1"
					checked="checked" /><?php echo $AppUI->_("Add 'DROP TABLE' to output-script"); ?><br />
			</td>
		</tr>
		<tr>
			...
			<td width="100%" nowrap="nowrap">
				<select name="output_format" class="text">
					<option value="zip" checked="checked">
						<?php echo $AppUI->_('Compressed ZIP SQL file', UI_OUTPUT_RAW); ?></option>
