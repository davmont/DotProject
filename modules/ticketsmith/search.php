...
print ("<tr>\n");
print ("<td><br /></td>\n");
print ('<td><input type="submit" class="button" value="' . $AppUI->_('Search') . '" /></td>');
print ("</tr>\n");
...
if ($search_pattern) {
    ...
    /* set fields */
    $fields = array(
        "columns" => array("ticket", "author", "subject", "timestamp", "type"),
    ...
    /* start results table */
    print ("<p>\n");
    print ("<table width=\"100%\" border=\"0\" cellpadding=\"2\" cellspacing=\"1\" class=\"tbl\">\n<tr>\n");
    foreach ($fields["columns"] as $col) {
        print ("<th>" . $AppUI->_(ucfirst($col)) . "</th>\n");
    }
    print ("</tr>\n");
