...
if( empty($_GET['clickedon']) ) {
   ...
   echo '<b style="color:darkred;">Clicked on bar: '.htmlspecialchars($_GET['clickedon']).'</b>';
}
echo '<p />';
if( empty($_GET['pie_clickedon']) ) {
   ...
   echo '<b style="color:darkred;">Clicked on pie slice: '.htmlspecialchars($_GET['pie_clickedon']).'</b>';
}
echo '<p />';
?>
