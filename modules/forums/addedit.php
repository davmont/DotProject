	...
	<table cellspacing="0" cellpadding="4" border="0" width="100%" class="std">
		...
		<tr>
			<td valign="top" width="50%">
				...
				<table cellspacing="1" cellpadding="2" width="100%">
					<tr>
						...
						<td>
							<input type="text" class="text" size="25" name="forum_name"
								value="<?php echo @$forum_info["forum_name"]; ?>" maxlength="50" style="width:200px;" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<?php
							echo arraySelect($projects, 'forum_project', 'size="1" class="text"', ((isset($forum_info['forum_project']) && $forum_info['forum_project'] != '') ? $forum_info['forum_project'] : $forum_project));
							?>
						</td>
					</tr>
					<tr>
						...
						<td>
							<?php
							echo arraySelect($users, 'forum_owner', 'size="1" class="text"', (isset($forum_info['forum_owner']) && $forum_info['forum_owner']) ? $forum_info['forum_owner'] : $AppUI->user_id);
							?>
						</td>
					</tr>
					<tr>
						...
						<td>
							<?php
							echo arraySelect($users, 'forum_moderated', 'size="1" class="text"', isset($forum_info['forum_moderated']) ? $forum_info['forum_moderated'] : '');
							?>
						</td>
					</tr>
					<?php if ($forum_id) { ?>
			...
			<td valign="top" width="50%">
				...
				<textarea class="textarea" name="forum_description" style="height:150px;" rows="10"
					cols="40"><?php echo @$forum_info["forum_description"]; ?></textarea>
			</td>
		</tr>
		...
		<tr>
			<td align="left">
				<input type="button" value="<?php echo $AppUI->_('back'); ?>" class="button"
					onclick="javascript:window.location='?m=forums';" />
			</td>
			<td align="right" colspan="2"><?php
			if ($AppUI->user_id == (isset($forum_info["forum_owner"]) ? $forum_info["forum_owner"] : '') || $forum_id == 0) {
