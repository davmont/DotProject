            ...
            if (count($items) == 0) {
                ...
                foreach ($items as $item) {
                    ...
                    if ($is_leaf == "1") {
                        ...
                        ?>
                        <tr id="row_<?php echo $id ?>"  onclick="expandControlWorkpackageActivities(<?php echo $id ?>)" style="cursor:pointer">                       
                                ...
                                <span id="edit_workpackage_id_<?php echo $id ?>" style="display:none">
                                    <form name="save_wbs_<?php echo $id ?>" id="save_wbs_<?php echo $id ?>" method="post" action="?m=dotproject_plus">
                                        ...
                                        <?php echo $AppUI->_("LBL_UNITY") ?>:
                                            ...
                                            <input type="text" class="text" name="estimated_size_unit_<?php echo $id ?>" id="estimated_size_unit_<?php echo $id ?>"  maxlength="30" size="25"  value="<?php echo $eapItem->getSizeUnit() ?>"  />
                                            <script>
