...
if (!($rows = $q->loadList())) {
    ...
    <div style="text-align: center">
        ...
        <?php echo $AppUI->_("LBL_CLICK"); ?> <a
            href="index.php?m=projects&a=addedit&company_id=<?php echo $company_id ?>"><b><u><?php echo $AppUI->_("LBL_HERE"); ?></u></b></a>
    ...
    <table class="tbl" width="100%" align="center" onmouseover="setContextDisabled(false)"
