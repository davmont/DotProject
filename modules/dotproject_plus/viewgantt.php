						...
						<tr>
							...
							<td align="left">
								<input type="button" class="button"
									...
									onclick='document.editFrm.display_option.value="custom";document.editFrm.printpdf.value="0";submit();' />
							</td>
				...
				<td align="right">
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td align="right">
								<input type="button" style="width: 110px;" class="button"
									value="<?php echo $AppUI->_('low resolution'); ?>" onclick='javascript:printPDF()' />
								&nbsp;
							</td>
							<td align="right">
								<input type="button" style="width: 110px;" class="button"
									value="<?php echo $AppUI->_('high resolution'); ?>"
									onclick='javascript:printPDFHR()' />
								&nbsp;
							</td>
						</tr>
					</table>
								...
								<table border="0" cellpadding="2" cellspacing="0" width="100%" align="center">
									<tr>
										...
										<td valign="top">
											...
											<label
												for="showTaskNameOnly"><?php echo $AppUI->_('Show names only'); ?></label>
										</td>
										...
										<td valign="top">
											...
											<label
												for="monospacefont"><?php echo $AppUI->_('Use MonoSpace Font'); ?></label>
										</td>
										...
										<td valign="top">
											...
											<label
												for="addLinksToGantt"><?php echo $AppUI->_('Add links to Gantt'); ?></label>
										</td>

										<td colspan=2 rowspan=2 valign="middle">&nbsp;<input type="button"
												style="float: right; width: 110px;" class="button"
									...
									<tr class="tbl">
										...
										<td class="alternate" valign="top">
											...
											<label
												for="showNoMilestones"><?php echo $AppUI->_('Hide Milestones'); ?></label>
										</td>
										...
										<td class="alternate" valign="top">
											...
											<label
												for="showhgrid"><?php echo $AppUI->_('Show horizontal grid'); ?></label>
										</td>
										...
										<td class="alternate" valign="top">
											<input type="checkbox" name="showWork" id="showWork" <?php echo (($showTaskNameOnly == 1) ? 'disabled="disabled"' : '');
											echo (($showWork == 1) ? 'checked="checked"' : ''); ?> />
											<label
												for="showWork"><?php echo $AppUI->_('Show work instead of duration (Hours)'); ?></label>
											<!--				</td>-->
...
-->
										...
										<tr>
											...
											<td valign="bottom" nowrap="nowrap">
												...
												<label
													for="showArcProjs"><?php echo $AppUI->_('Archived Projects'); ?></label>
											</td>
											<td valign="bottom" nowrap="nowrap">
												<input type="checkbox" name="showHoldProjs" id="showHoldProjs" <?php echo $showHoldProjs ? 'checked="checked"' : ''; ?> />
												<label
													for="showHoldProjs"><?php echo $AppUI->_('Projects on Hold'); ?></label>
											</td>
											<td valign="bottom" nowrap="nowrap">
											...
											<td valign="bottom" nowrap="nowrap">
												...
												<label
													for="showLowTasks"><?php echo $AppUI->_('Low Priority Tasks'); ?></label>
											</td>
											<td>&nbsp;</td>
										</tr>
									<?php } ?>
...
<table cellspacing="0" cellpadding="2" border="1" align="center" bgcolor="white">
	<tr>
		<th colspan="9"> Gantt chart key: </th>
	</tr>
	<tr>
	...
	if ($showNoMilestones != 1) {
		...
		<tr>
			...
			<td align="center"><img src="<?php echo DP_BASE_URL; ?>/modules/tasks/images/milestone_planned.png" alt="" />
			</td>
			<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Milestone (completed)') ?>&nbsp;</td>
			<td align="center"><img src="<?php echo DP_BASE_URL; ?>/modules/tasks/images/milestone_completed.png" alt="" />
			</td>
			<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Milestone (in progress)') ?>&nbsp;
			</td>
			<td align="center"><img src="<?php echo DP_BASE_URL; ?>/modules/tasks/images/milestone_in_progress.png" alt="" />
			</td>
			<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $AppUI->_('Milestone (overdue)') ?>&nbsp;</td>
			<td align="center"><img src="<?php echo DP_BASE_URL; ?>/modules/tasks/images/milestone_overdue.png" alt="" />
			</td>
		</tr>
		<?php
	}
			...
			if ($cnt[0]['N'] > 0) {
				...
				*/
				...
				if ($addLinksToGantt == 1) {
					?>
					<iframe width="980px" height="500px" align="middle" src="<?php echo DP_BASE_URL . '/index.php' . $src; ?>"
						title="Please wait while the Gantt Chart is generated. (this might take up to a couple of minutes to complete)">Your
						current browser does not support frames. As a result this feature is not available.</iframe>
					<?php
				} else {
					?>
					<script language="javascript"
						type="text/javascript"> document.write('<img alt="Please wait while the Gantt chart is generated... (this might take a minute or two)" src="<?php echo $src; ?>" />') </script>
					<?php
				}
