		...
		<tr>
			<td>
				<table width="100%" cellpadding="3" cellspacing="0" border="0">
					<tr>
						<th class="banner" align="left"><strong><?php
						...
						<th class="banner" align="right" width='50'><a href='http://www.dotproject.net/' <?php if ($dialog)
							echo "target='_blank'"; ?>><img
									src="style/<?php echo $uistyle; ?>/images/dp_icon.gif" border="0"
									alt="http://dotproject.net/" /></a></th>
					</tr>
				</table>
			</td>
		</tr>
					...
					<table cellspacing="0" cellpadding="3" border="0" width="100%">
						<tr>
							...
							<td nowrap="nowrap">
								...
								<a
									href="./index.php?m=admin&amp;a=viewuser&amp;user_id=<?php echo $AppUI->user_id; ?>"><?php echo $AppUI->_('My Info'); ?></a>
								|
								<?php
								if (getPermission('calendar', 'access')) {
									...
									<a
										href="./index.php?m=calendar&amp;a=day_view&amp;date=<?php echo $now->format(FMT_TIMESTAMP_DATE); ?>"><?php echo $AppUI->_('Today'); ?></a>
									|
								<?php } ?>
